...
urlpatterns = [
    path('tpportal/updatestudentplacement', views.updatestudentplacement, name="updatestudentplacement"),
    path('tpportal/verifystudents', views.verifystudents, name="verifystudents"),
    path('tpportal/addannouncements', views.addannouncements, name="addannouncements"),
    path('announcements', views.announcements, name="announcements"),
    path('registerforplacements', views.registerforplacements, name="registerforplacements"),
    path('otpverification', views.otpverification, name="otpverification"),
    path('complete_registration', views.completeregistration, name="complete_registration"),
    path('tpportal/', views.tpportal, name="tpportal"),
    path('tpportal/logout',views.logout,name="logout"),
    path('tplogin',views.tplogin,name="tplogin"),
    path('studentcoordinatorlogin',views.studentcoordinatorlogin,name="studentcoordinatorlogin"),
    path('studentcoordinatorverifystudents',views.studentcoordinatorverifystudents,name="studentcoordinatorverifystudents"),
    path('assignstudentcoordinator',views.assignstudentcoordinator,name="assignstudentcoordinator"),
    path('stats',views.stats,name="stats"),
    ...
    path('',views.navigatetoindex,name='navigatetoindex'),
    path('home_page_view',home_page_view,name="home_page"),
    path('upload/',upload_page_view,name="upload_page"),
    path('edit/',edit_page_view,name="edit_page"),
    path('edit/view_selected_table/',view_selected_table_view,name="view_selected_table"),
